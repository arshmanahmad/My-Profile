...
const Hero = ({
  ...
  const socialLinks = [
    {
      ...
      label: "GitHub",
      className:
        "bg-[#1F2937]/50 hover:bg-[#374151]/50 text-[#9CA3AF] hover:text-[#FFFFFF]",
    },
    {
      ...
      label: "LinkedIn",
      className:
        "bg-[#3B82F6]/20 hover:bg-[#3B82F6]/30 text-[#3B82F6] hover:text-[#60A5FA]",
    },
    {
      ...
      label: "Email",
      className:
        "bg-[#10B981]/20 hover:bg-[#10B981]/30 text-[#10B981] hover:text-[#34D399]",
    },
  ];
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center px-2 sm:px-4 md:px-6 lg:px-8 xl:px-12 pt-12 sm:pt-16 md:pt-20 relative"
    >
      <div className="">
        ...
        >
          <div className="mb-4 sm:mb-6 md:mb-8 w-full">
            ...
            >
              <span className="text-[#10B981]">Full-Stack</span> Developer &{" "}
              <span className="text-[#3B82F6]">Automation</span> Expert
            </motion.h2>
            ...
            >
              ...
              <span className="text-[#3B82F6] font-semibold">4+ years</span> of
              expertise in
              ...
              . I deliver scalable solutions that drive growth and optimize
              performance.
            </motion.p>
          </div>
